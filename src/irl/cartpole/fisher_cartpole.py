...
class WarmupLR(torch.optim.lr_scheduler.LRScheduler):
    def __init__(self, optimizer, warmup_steps: int, gamma: float = 0.95, min_lr: float = 0.0, last_epoch: int = -1):
...
def main():
    ...
    report_path = Path(log_cfg.get("report_dir", "reports")) / "fisher_cartpole_history.json"
